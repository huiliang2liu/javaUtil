...
public class Object2Xml {
	...
	private static void map_2_xml(Map<String, Object> map,Node node,Document document) {
			...
			while (iterator.hasNext()) {
				...
				if (object instanceof Map)
					...
					list_2_xml((List<Object>) object,element,document);
						...
						|| object instanceof Double||object instanceof Integer || object instanceof Long
	...
	@SuppressWarnings("unchecked")
	private static void list_2_xml(List<Object> list,Node node,Document document) {
				...
				if (fields != null && fields.length > 0) {
					for (int i = 0; i < fields.length; i++) {
						...
						if (object2 instanceof Map)
							map_2_xml((Map<String, Object>) object2,element,document);
						else if (object2 instanceof List)
							list_2_xml((List<Object>) object2,element,document);
						else if (object2 instanceof String
								|| object2 instanceof Float
								|| object2 instanceof Double||object2 instanceof Integer
