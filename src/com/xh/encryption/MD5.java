...
public class MD5 {
	private final static String TAG = "com.example.encryption.MD5";
...
//		System.out.println(String2MD5Method("xiaohei"));
//		System.out.println(String2MD5Method1("xiaohei"));
		System.out.println(MD5.String2MD5Method1(System.currentTimeMillis()+"DHXL").toUpperCase());
//		String s="xiaohei1";
//		byte[] b=s.getBytes();
